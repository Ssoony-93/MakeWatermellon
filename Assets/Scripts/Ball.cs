    ...
    private void OnCollisionStay2D(Collision2D collision)
    {
        if(collision.gameObject.tag == "Ball")
        {
            ...
            {   
                ...
                float otherX = collision.transform.position.x; //튜터님은 collision.transform.position.x;
                float otherY = collision.transform.position.y; //유툽에선 other.transform.position.x;
                //1. 내가 아래에 있을 때
